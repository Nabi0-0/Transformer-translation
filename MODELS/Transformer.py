...
class Transformer(nn.Module):
    def __init__(self, input_vocab_size, target_vocab_size, d_model, num_heads, d_ff, num_layers, dropout):
        ...
        self.encoder = EncoderBlock(input_vocab_size, d_model, num_heads, d_ff, num_layers, dropout)
        self.decoder = DecoderBlock(target_vocab_size, d_model, num_heads, d_ff, num_layers, dropout)
